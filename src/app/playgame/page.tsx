      ...
      {isPortrait && (
        <div className="absolute inset-0 z-50 flex flex-col items-center justify-center bg-gradient-to-br from-black via-gray-900 to-black p-8">
          ...
          <div className="text-center max-w-sm">
            ...
            {isInAppBrowser() && (
              <div className="mt-8 bg-orange-900/30 border border-orange-500/50 rounded-lg p-4 max-w-xs">
                <div className="flex items-start gap-2 mb-3">
                  <svg className="w-5 h-5 text-orange-400 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
                  </svg>
                  <p className="text-orange-200 text-sm">
                    <strong>{getInAppBrowserName()}</strong> browser doesn't support screen rotation.
                  </p>
                </div>
